...
`Link to Data Visualization Portal <https://visualization.genelab.nasa.gov/data/>`_ (\ `https://visualization.genelab.nasa.gov/data/ <https://visualization.genelab.nasa.gov/data/>`_\ )
...
* The OSDR has many data visualization tools suitable for multiple applications and stakeholders.&#x20;
  ...
  * **Data & Tools: Use the dropdown menu to access the** “\ `Data Visualization <https://visualization.genelab.nasa.gov/data/>`_\ ” hyperlink to open the OSDR multi-study data visualization application.

`Link to detailed Multi-study visualization tutorial <https://genelab.nasa.gov/sites/default/files/2024-03/Data%20Visualization%20Portal%20JT\_AU.pdf>`_

{% embed url="https://genelab.nasa.gov/sites/default/files/2024-03/Data%20Visualization%20Portal%20JT_AU.pdf" %}

**Metadata Dashboard** :raw-html-m2r:`<a href="#id-18i9g98tw37j" id="id-18i9g98tw37j"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

`Link to Metadata Dashboard <https://visualization.genelab.nasa.gov/data/>`_
...
&#x20;\ :raw-html-m2r:`<a href="#uk50q5k2hiyu" id="uk50q5k2hiyu"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Selecting “processed studies” to find higher-order data. :raw-html-m2r:`<a href="#uk50q5k2hiyu" id="uk50q5k2hiyu"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
&#x20;\ :raw-html-m2r:`<a href="#e5g8py1a7trn" id="e5g8py1a7trn"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Bar charts of factors :raw-html-m2r:`<a href="#e5g8py1a7trn" id="e5g8py1a7trn"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
&#x20;\ :raw-html-m2r:`<a href="#baeehoyiz78k" id="baeehoyiz78k"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Selecting a study or group of studies for visualization :raw-html-m2r:`<a href="#baeehoyiz78k" id="baeehoyiz78k"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
&#x20;\ :raw-html-m2r:`<a href="#s7aljci4w0hb" id="s7aljci4w0hb"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Studies Metadata Menu as a Table :raw-html-m2r:`<a href="#s7aljci4w0hb" id="s7aljci4w0hb"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Selecting studies for Multi-study analysis: :raw-html-m2r:`<a href="#adcagqrqpdky" id="adcagqrqpdky"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
&#x20;\ :raw-html-m2r:`<a href="#n1ennvxv3ysp" id="n1ennvxv3ysp"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Multi-study Data Normalization: :raw-html-m2r:`<a href="#n1ennvxv3ysp" id="n1ennvxv3ysp"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
&#x20;\ :raw-html-m2r:`<a href="#oek6t1v60xxg" id="oek6t1v60xxg"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Multi-study Sidebar Functions :raw-html-m2r:`<a href="#oek6t1v60xxg" id="oek6t1v60xxg"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Plotly :raw-html-m2r:`<a href="#id-6klo26n9so4x" id="id-6klo26n9so4x"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
&#x20;\ :raw-html-m2r:`<a href="#pf6ggq2bhe0b" id="pf6ggq2bhe0b"></a>`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

PCA Plots :raw-html-m2r:`<a href="#zgf6azkbfb8w" id="zgf6azkbfb8w"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
`Link to read about PCA plots <https://builtin.com/data-science/step-step-explanation-principal-component-analysis>`_
...
Pair Plots :raw-html-m2r:`<a href="#a8pdjzjwz1gr" id="a8pdjzjwz1gr"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

`Link to read about Pair Plots <https://medium.com/analytics-vidhya/pairplot-visualization-16325cd725e6>`_
...
Volcano Plots :raw-html-m2r:`<a href="#v6dx63l0d9d" id="v6dx63l0d9d"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

`Link to read about Volcano Plots <https://www.htgmolecular.com/blog/2022-08-25/understanding-volcano-plots>`_
...
Customizing volcano plots :raw-html-m2r:`<a href="#xqfjx7fvgehs" id="xqfjx7fvgehs"></a>`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Heatmaps :raw-html-m2r:`<a href="#id-90l4f2mpkzz5" id="id-90l4f2mpkzz5"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

`Link to read about Heatmaps <https://www.htgmolecular.com/blog/2023-05-03/understanding-heat-maps-in-gene-expression-profiling>`_
...
&#x20;\ :raw-html-m2r:`<a href="#gehyxb9h3uh2" id="gehyxb9h3uh2"></a>`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Ideogram :raw-html-m2r:`<a href="#k0o83ew6adb9" id="k0o83ew6adb9"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
`Link to read about Ideograms <https://en.wikipedia.org/wiki/Ideogram>`_
...
&#x20;\ :raw-html-m2r:`<a href="#id-4ngxvslairnl" id="id-4ngxvslairnl"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

DGE Table :raw-html-m2r:`<a href="#id-2ub25g3cd45c" id="id-2ub25g3cd45c"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
#. **Locate the DGE Table:** Scroll down to the bottom of the study visualization page. There, you'll find the Differential Gene Expression table containing valuable data.
#. **Copy the Table to Clipboard:** Identify the "Copy" button within the DGE table. It should be prominently displayed. Click the "Copy" button. This action will copy the entire table, including all data, headers, and values, to your device's clipboard which can then be placed into Word documents and/or spreadsheets.
#. **Or save and export:** As CSV, Excel, PDF, or send to Printer for a physical copy:
...
&#x20;\ :raw-html-m2r:`<a href="#id-8vsniiswkqfg" id="id-8vsniiswkqfg"></a>`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Multiple study GSEA :raw-html-m2r:`<a href="#d7vfdcantbds" id="d7vfdcantbds"></a>`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
`Link to read about GSEA <https://www.pnas.org/doi/10.1073/pnas.0506580102>`_
...
#. **Choose genesets:** Select the database geneset enrichment analysis. The default is "KEGG 2019," which is recommended.
...
&#x20; :raw-html-m2r:`<a href="#l8m8wfdlxlsd" id="l8m8wfdlxlsd"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

&#x20;\ :raw-html-m2r:`<a href="#id-9fsa75cgexjv" id="id-9fsa75cgexjv"></a>`
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
